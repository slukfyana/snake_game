...
class MAIN:
    ...
    def draw_score(self):
        ...
        food_rect = food.get_rect(midright=(score_rect.left,score_rect.centery))
        bg_rect = pygame.Rect(food_rect.left,food_rect.top,food_rect.width+score_rect.width,food_rect.height)
...
food = pygame.image.load('Graphics/lily.png').convert_alpha()
